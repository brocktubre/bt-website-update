...
export class GradesComponent extends AuthHelper implements OnInit {
  ...
  public columns: Array<any> = [
    ...
    {title: 'A 2.2 (100)', name: 'assignment_2_2', sort: ''},
    {title: 'A 2.3 (250)', name: 'assignment_2_3', sort: ''},
    {title: 'Midterm (360)', name: 'midterm'},
  ...
  constructor(private dynamodbIntService: DynamodbIntService,
              ...
              private lambdaIntService: LambdaIntService,
  ...
  public loadAttendance(secretId: string) {
    this.lambdaIntService.triggerFunction(this.functionName, secretId).subscribe(items => {
      this.lambdaIntService.triggerFunctionGetTotal(this.functionNameGetTotal).subscribe(total => {
